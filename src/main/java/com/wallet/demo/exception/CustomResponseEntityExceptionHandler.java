...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler
	public final ResponseEntity<?> handleWalletNotEnoughPayException(final WalletNotEnoughPayException ex,
			final WebRequest request) {
		WalletExceptionResponse response = new WalletExceptionResponse(ex.getMessage());
		return new ResponseEntity<WalletExceptionResponse>(response, HttpStatus.INTERNAL_SERVER_ERROR);
	}
}
